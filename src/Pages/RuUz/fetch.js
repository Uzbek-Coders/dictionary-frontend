...
text = text.replace("izhoh|", "")
    ...
    if (ruIndex !== -1) {
        console.log(text)
        // const ruIndex1 = text.search(reg1)
      //   const ruLastIndex = text.lastIndexOf(text.match(reg1).pop())
      //   text = text.substring(ruIndex, ruLastIndex).replace(reg1, "").split(" ")
      // let  text1 = text.shift()w
      //   text = text.join(" ")
