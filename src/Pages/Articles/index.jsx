    ...
    <Grid container maxWidth='lg' padding={!isDesktop ? '40px 5%' : '40px'} margin='0 auto' alignItems='start'>
      ...
      <Grid item xs={12} lg={7}>
        <Paper sx={{
          ...
          . <Link color='#01756C' onClick={showAll} sx={{ cursor: 'pointer' }}>Show all posts</Link>.
        </Paper>
      ...
      <Grid item xs={12} lg={5} paddingLeft={isDesktop ? '40px' : 0} paddingTop='20px'>
        <Card>
          <CardContent sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            <TextField label="Search" variant='outlined' size='small' sx={{ width: '65%' }} id='text' />
            <Button
              onClick={search}
              variant='contained'
              size='small'
              sx={{ bgcolor: '#01756C', marginLeft: 1, width: '35%', ':hover': { color: '#01756C', bgcolor: '#fff' } }}>
              Search
            </Button>
          </CardContent>
        </Card>
