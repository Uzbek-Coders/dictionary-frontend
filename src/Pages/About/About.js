...
export const About = () => {
  return (
    <div style={{ background: "#f2f2f2"}}>
      <div  className="font-weight-normal" style={{marginTop: "48px", fontStyle:"italic", width: "68%",wordSpacing:"0.75", textAlign: "center", margin: "0 auto", fontFamily: "Roboto", fontSize: "18px"}}>
...
<div style={{ backgroundColor: "#f2f2f2", paddingTop: "24px"}}>
      ...
      <div style={{width: "72%",marginTop:"66px",  margin: "0 auto", textAlign: "center"}}>
        ...
        {/* <br/> */}
        {/* <div className="info" style={{padding: "6px", borderRadius: "5px", background: "#c6e7ed", color: "#797878"}}> */}
...
<ul style={{lineHeight: "25px", fontFamily: "Roboto"}}>
  ...
  <li>and much more.</li>
      ...
      <div className="u-body u-xl-mode">
        <section className="u-clearfix u-grey-5 u-section-2" id="carousel_c549">
